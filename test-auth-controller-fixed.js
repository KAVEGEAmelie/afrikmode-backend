...
async function testAuthControllerFixed() {
  console.log('🔍 Test du contrôleur d\'authentification avec gestion d\'erreur...\n');
...
testAuthControllerFixed().catch(console.error);
