 ...
 * @access Private
 */
router.post('/addresses', requireAuth, userController.createUserAddress);
 ...
 * @access Private
 */
router.put('/addresses/:id', requireAuth, userController.updateUserAddress);
 ...
 * @access Private
 */
router.delete('/addresses/:id', requireAuth, userController.deleteUserAddress);
